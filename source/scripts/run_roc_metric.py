...
if __name__ == "__main__":
    ...
    folder_name_class_0 = ['1585701511_0_3sec_100traj_3model_functionPolicy',
                           '1585753600_0_3sec_100traj_3model_functionPolicy',
                           '1585756230_0_3sec_100traj_3model_functionPolicy',
                           # '1585762356_0_3sec_100traj_3model_functionPolicy',
                           '1585766034_0_3sec_100traj_3model_functionPolicy',
                           '1585778284_0_3sec_100traj_3model_functionPolicy',
                           '1585781372_0_3sec_100traj_3model_functionPolicy'
                           ]
    ...
    folder_name_class_1 = ['1585784394_0_3sec_100traj_3model_functionPolicy'
                           ]
    ...
    plt.savefig(path_to_data+ '/AUROC_100samples_negllh.png')
    plt.show()
