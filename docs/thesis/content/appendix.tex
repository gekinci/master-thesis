...
\begin{figure}[htb]
	...
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{figures/roc_exactUpdate/AUROC_2000samples_class0_llh_n5}
		\caption{}
		\label{fig:roc_exact_n5}
	\end{subfigure}\\
	\begin{subfigure}{.33\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{figures/roc_exactUpdate/AUROC_2000samples_class0_llh_n10}
		\caption{}
